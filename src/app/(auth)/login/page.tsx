...
export default function Login() {
  return (
    <div className="flex h-dvh">
      ...
      <div className="relative hidden overflow-hidden bg-gradient-to-br from-rose-100 via-pink-50 to-purple-50 lg:block lg:w-1/3">
      ...
      {/* Right Side – Login */}
      <div className="flex w-full items-center justify-center bg-gradient-to-br from-white via-rose-50/30 to-purple-50/30 p-8 lg:w-2/3">
        <div className="w-full max-w-md space-y-10 py-24 lg:py-32">
          <div className="space-y-4 text-center">
            <div className="mb-2 inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-rose-100 to-pink-100 shadow-sm">
              <span className="text-2xl">🌸</span>
            </div>
